...
public class DoctorsController : BaseController
{
    ...
    [HttpGet("{doctorId}/schedule-slots")]
    public async Task<ActionResult<GetDoctorSchedulesByDoctorIdResponse>> GetScheduleSlotsByDoctorId([FromRoute] Guid doctorId)
    {
        var query = new GetDoctorSchedulesByDoctorIdQuery() { DoctorID = doctorId };
